...
- `src/biocybe/cli.py` — point d'entrée `biocybe`, sous-commandes : `scan`, `quarantine list/restore`, `intel update/rules`, `tcell train/status/evaluate`, `api serve`, `notify list/test`, `audit show/verify`
