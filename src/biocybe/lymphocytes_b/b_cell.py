        ...
        try:
            ...
            try:
                ...
                logger.warning(
                    ...
                    "Bascule en mode tolérant fichier par fichier.",
                    exc,
                )
...
class ScanResult:
    ...
    def __str__(self):
        if self.is_malicious:
            return (
                f"Malveillant: Oui | Famille: {self.malware_family} | "
...
class BCell(BiologicalCell):
    ...
    def __init__(self, name: str, config: dict = None):
        ...
        self.logger.info(
            f"Lymphocyte B '{name}' initialisé avec {len(self.db.signatures)} signatures hash"
        )
    ...
    def _process_cycle(self):
        ...
        try:
            ...
            try:
                _priority, task = self.scan_queue.get(block=False)
        ...
        try:
            ...
            if is_malicious:
                ...
                result.matched_signatures.append(
                    {"type": "hash", "value": hash_info.get("hash", "unknown"), "info": hash_info}
                )
            else:
                ...
                if is_malicious_yara:
                    ...
                    if severities:
                        ...
                        result.severity = max(severities, key=lambda s: severity_order.get(s, 0))
    ...
    def _alert_malware_detection(self, file_path: str, result: ScanResult):
        ...
        severity_priority = {"critical": 5, "high": 4, "medium": 3, "low": 2, "unknown": 1}
        ...
        self.send_message(
            ...
            target="broadcast",
            payload={"file_path": file_path, "result": result.to_dict(), "detected_by": self.name},
            priority=3,
        )
        ...
        self.send_message(
            ...
            payload={
                ...
                "hash_signatures": {
                    ...
                    for key in result.matched_signatures
                    if key in self.db.signatures
                },
                "detected_by": self.name,
            },
            priority=2,
    ...
    def _handle_update_signatures(self, message: CellMessage):
        ...
        self.send_message(
            ...
            payload={
                ...
                "message": "Mise à jour des signatures effectuée"
                if success
                else "Échec de la mise à jour des signatures",
            },
        )
